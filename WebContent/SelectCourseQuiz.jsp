...
<body style="background-image: url(img/q.jpg); background-repeat:no-repeat;background-size: contain;background-attachment:fixed; margin-top:50px;">


<div class="container-fluid">

<div class="card" style="margin-top:280px;">
<div>
...
<input class="btn btn-primary" type="submit" value="Begin Quiz" style="background-color:#FF8000;">
</form>
</div>
 </div>
</div>
